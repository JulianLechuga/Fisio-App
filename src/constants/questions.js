...
export const microVirusQuestions = [
  {
    id: 1,
    title: "Con respecto a los virus de ARN, señale la opción INCORRECTA:",
    option1: "Pueden tener ARN de sentido positivo o negativo.",
    option2: "La replicación del ARN viral siempre ocurre en el núcleo.",
    option3:
      "Muchos virus de ARN utilizan una ARN polimerasa viral para replicarse.",
    option4: "El ARN viral puede ser monocatenario o bicatenario.",
    correct: "La replicación del ARN viral siempre ocurre en el núcleo.",
  },
  {
    id: 2,
    title: "Con respecto a los retrovirus, señale la opción INCORRECTA:",
    option1: "Poseen una enzima llamada transcriptasa inversa.",
    option2: "Su genoma es ADN bicatenario lineal.",
    option3: "El VIH es un retrovirus.",
    option4: "El ADNc viral se integra en el genoma del huésped.",
    correct: "Su genoma es ADN bicatenario lineal.",
  },
  {
    id: 3,
    title:
      "¿Cuál de los siguientes mecanismos NO es una estrategia de evasión inmune por parte de los virus?",
    option1: "Mutación rápida de proteínas de superficie.",
    option2:
      "Producción de proteínas que interfieren con la presentación de antígenos.",
    option3: "Inducción de apoptosis en células inmunes.",
    option4:
      "Estabilización de la envoltura viral mediante enlaces covalentes.",
    correct:
      "Estabilización de la envoltura viral mediante enlaces covalentes.",
  },
  {
    id: 4,
    title:
      "¿Cuál de los siguientes NO es un factor de virulencia común en los virus?",
    option1: "La capacidad de inhibir la síntesis de proteínas del huésped.",
    option2: "La capacidad de inducir la formación de sincitios.",
    option3: "La capacidad de formar esporas.",
    option4: "La capacidad de evitar la detección por el sistema inmune.",
    correct: "La capacidad de formar esporas.",
  },
  {
    id: 5,
    title: "Con respecto a los virus oncogénicos, señale la opción INCORRECTA:",
    option1:
      "Pueden causar transformación celular al integrar su ADN en el genoma del huésped.",
    option2: "El virus del papiloma humano (VPH) es un virus oncogénico.",
    option3: "Los retrovirus oncogénicos pueden portar oncogenes virales.",
    option4: "Todos los virus oncogénicos son virus de ADN.",
    correct: "Todos los virus oncogénicos son virus de ADN.",
  },
  {
    id: 6,
    title:
      "¿Cuál de las siguientes características NO es típica de los virus de ADN?",
    option1: "La replicación del ADN viral generalmente ocurre en el núcleo.",
    option2: "Utilizan la maquinaria de replicación del ADN del huésped.",
    option3: "El genoma puede ser circular o lineal.",
    option4: "Siempre tienen un ciclo de vida lisogénico.",
    correct: "Siempre tienen un ciclo de vida lisogénico.",
  },
  {
    id: 7,
    title:
      "¿Cuál es la función de la proteína hemaglutinina en los virus de la influenza?",
    option1:
      "Permite la unión del virus a los receptores celulares del huésped.",
    option2: "Degrada la membrana celular del huésped.",
    option3: "Promueve la liberación de nuevas partículas virales.",
    option4: "Induce la replicación del genoma viral.",
    correct:
      "Permite la unión del virus a los receptores celulares del huésped.",
  },
  {
    id: 8,
    title:
      "¿Cuál de los siguientes NO es un mecanismo de acción de los fármacos antivirales?",
    option1: "Inhibición de la síntesis de ácidos nucleicos virales.",
    option2: "Inhibición de la liberación de partículas virales.",
    option3:
      "Inhibición de la fusión de la envoltura viral con la membrana celular.",
    option4: "Inducción de la apoptosis en células infectadas.",
    correct: "Inducción de la apoptosis en células infectadas.",
  },
  {
    id: 9,
    title:
      "¿Cuál de los siguientes eventos ocurre durante el ciclo de vida de un virus de ARN de sentido positivo?",
    option1: "El ARN viral se transcribe a ADN en el núcleo.",
    option2: "El ARN viral se traduce directamente a proteínas virales.",
    option3:
      "El ARN viral primero debe ser replicado a ARN de sentido negativo.",
    option4: "El genoma viral se integra en el ADN del huésped.",
    correct: "El ARN viral se traduce directamente a proteínas virales.",
  },
  {
    id: 10,
    title: "Con respecto a los virus envueltos, señale la opción CORRECTA:",
    option1: "Carecen de proteínas de envoltura.",
    option2: "Su envoltura se deriva de la membrana celular del huésped.",
    option3:
      "Son siempre más resistentes a las condiciones ambientales que los virus no envueltos.",
    option4: "Nunca poseen una cápside proteica.",
    correct: "Su envoltura se deriva de la membrana celular del huésped.",
  },
  {
    id: 11,
    title: "¿Qué característica define a un bacteriófago?",
    option1: "Infecta exclusivamente células animales.",
    option2: "Es un virus que infecta bacterias.",
    option3: "Tiene un genoma de ARN monocatenario.",
    option4: "Siempre causa la lisis de la célula huésped.",
    correct: "Es un virus que infecta bacterias.",
  },
  {
    id: 12,
    title:
      "¿Cuál de los siguientes NO es un componente estructural típico de un virus?",
    option1: "Cápside proteica.",
    option2: "Material genético.",
    option3: "Ribosomas.",
    option4: "Envoltura lipídica.",
    correct: "Ribosomas.",
  },
  {
    id: 13,
    title:
      "Con respecto a la replicación del virus del VIH, señale la opción INCORRECTA:",
    option1: "La transcriptasa inversa convierte el ARN viral en ADNc.",
    option2: "El ADNc viral se integra en el genoma del huésped.",
    option3:
      "La proteasa viral es crucial para la maduración de las nuevas partículas virales.",
    option4: "La replicación del VIH ocurre exclusivamente en el citoplasma.",
    correct: "La replicación del VIH ocurre exclusivamente en el citoplasma.",
  },
  {
    id: 14,
    title: "¿Qué tipo de ciclo de vida tiene un virus lisogénico?",
    option1: "Causa la lisis inmediata de la célula huésped.",
    option2: "Integra su genoma en el ADN del huésped y permanece inactivo.",
    option3: "Replica su genoma en el citoplasma del huésped.",
    option4: "Produce proteínas virales sin integrar su genoma.",
    correct: "Integra su genoma en el ADN del huésped y permanece inactivo.",
  },
  {
    id: 15,
    title: "Con respecto a los virus zoonóticos, señale la opción CORRECTA:",
    option1: "Se transmiten exclusivamente entre humanos.",
    option2: "No pueden infectar a los humanos.",
    option3: "Se originan en animales y pueden transmitirse a humanos.",
    option4: "Siempre causan enfermedades graves en humanos.",
    correct: "Se originan en animales y pueden transmitirse a humanos.",
  },
  {
    id: 16,
    title: "¿Qué característica distingue a un prion de un virus?",
    option1: "Contiene material genético.",
    option2: "Es una proteína infecciosa sin material genético.",
    option3: "Puede replicarse fuera de una célula huésped.",
    option4: "Tiene una cápside proteica.",
    correct: "Es una proteína infecciosa sin material genético.",
  },
  {
    id: 17,
    title:
      "Con respecto a los virus ARN de sentido negativo, señale la opción CORRECTA:",
    option1: "Su ARN puede ser traducido directamente a proteínas.",
    option2:
      "Necesitan una ARN polimerasa dependiente de ARN para la replicación.",
    option3: "Siempre tienen un genoma bicatenario.",
    option4: "Se replican en el núcleo de la célula huésped.",
    correct:
      "Necesitan una ARN polimerasa dependiente de ARN para la replicación.",
  },
  {
    id: 18,
    title:
      "¿Cuál de los siguientes eventos NO es parte del ciclo de replicación viral?",
    option1: "Adsorción del virus a la célula huésped.",
    option2: "Fusión de la envoltura viral con la membrana celular.",
    option3: "Transcripción y traducción del genoma viral.",
    option4: "Reparación del ADN viral dañado.",
    correct: "Reparación del ADN viral dañado.",
  },
  {
    id: 19,
    title:
      "Con respecto al ciclo lítico de un bacteriófago, señale la opción INCORRECTA:",
    option1: "El ADN del bacteriófago se integra en el genoma bacteriano.",
    option2:
      "El bacteriófago utiliza la maquinaria de replicación de la bacteria.",
    option3:
      "Se producen nuevas partículas de bacteriófagos dentro de la bacteria.",
    option4: "La célula bacteriana se lisa para liberar nuevos bacteriófagos.",
    correct: "El ADN del bacteriófago se integra en el genoma bacteriano.",
  },
  {
    id: 20,
    title:
      "¿Qué proceso permite la variabilidad genética en los virus de la influenza?",
    option1: "Recombinación genética con el genoma del huésped.",
    option2:
      "Segmentación del genoma y redistribución de segmentos entre diferentes virus.",
    option3: "Replicación de alta fidelidad del ARN viral.",
    option4: "Transducción mediada por bacteriófagos.",
    correct:
      "Segmentación del genoma y redistribución de segmentos entre diferentes virus.",
  },
  // PREGUNTAS DE CHOICE
  {
    id: 21,
    title: "En relación a los diferentes factores que regulan el control de las infecciones virales, señale la opción CORRECTA:",
    option1: "El virus del sarampión es más factible de erradicar que el virus de la viruela.",
    option2: "La diversidad de serotipos de un virus dado es irrelevante para lograr una vacuna eficaz.",
    option3: "Si un virus es citolítico no podrá ser neutralizado por anticuerpos tipo IgG.",
    option4: "Las infecciones por virus de transmisión zoonótica están imposibilitadas de inmunoprimirse.",
    correct: "El virus del sarampión es más factible de erradicar que el virus de la viruela."
  },
  {
    id: 22,
    title: "Entre los siguientes enunciados, señale el INCORRECTO:",
    option1: "Un virión puede replicar en células no permisivas, aunque con menor eficiencia.",
    option2: "Las proteínas no estructurales pueden actuar directamente en el daño celular.",
    option3: "La coinfección de una célula con variantes genómicas diferentes de un virus dado favorece la variabilidad genética.",
    option4: "Un mismo virus puede diseminarse por las vías neural y hemática.",
    correct: "Las proteínas no estructurales pueden actuar directamente en el daño celular."
  },
  {
    id: 23,
    title: "Entre las siguientes asociaciones, señale la que considere INCORRECTA:",
    option1: "Virus herpes simplex/encefalitis en inmunocompetentes.",
    option2: "Parvovirus B19/exantema vírico infeccioso en niños.",
    option3: "Virus del sarampión/inmunosupresión transitoria.",
    option4: "Síndrome de rubéola congénita/infección persistente hasta el año de vida.",
    correct: "Síndrome de rubéola congénita/infección persistente hasta el año de vida."
  },
  {
    id: 24,
    title: "En relación a la patogénesis de la infección por el virus de la hepatitis C (HCV), señale la opción CORRECTA:",
    option1: "La persistente expresión de ciertas proteínas virales puede alterar vías celulares relacionadas con la proliferación y la apoptosis de los hepatocitos.",
    option2: "El desarrollo del hepatocarcinoma (HCC) está asociado a procesos de inestabilidad génica debido a la integración del genoma viral en el genoma del hepatocito.",
    option3: "Para el desarrollo del hepatocarcinoma (HCC) por HCV es necesaria la integración del genoma viral al genoma del hepatocito.",
    option4: "La variabilidad genética del HCV es ocasionada, en parte, por los errores que se introducen durante la replicación del ADN viral.",
    correct: "La persistente expresión de ciertas proteínas virales puede alterar vías celulares relacionadas con la proliferación y la apoptosis de los hepatocitos."
  },
  {
    id: 25,
    title: "Entre las siguientes opciones, señale la que considere CORRECTA:",
    option1: "Por utilizar la ADN polimerasa celular, el HBV presenta muy baja tasa de mutaciones aun siendo un virus de ADN.",
    option2: "La trombocitopenia es habitualmente observada durante el curso de la fiebre amarilla o el dengue.",
    option3: "Entre los mecanismos asociados a la evasión a la respuesta inmune por el EBV, resalta la capacidad de generar cuasiespecies heterogéneas.",
    option4: "En el sarcoma de Kaposi de un hospedador con sida, la angiogénesis está exacerbada en las células infectadas por HIV.",
    correct: "Entre los mecanismos asociados a la evasión a la respuesta inmune por el EBV, resalta la capacidad de generar cuasiespecies heterogéneas."
  },
  {
    id: 26,
    title: "Con respecto a las infecciones por virus del género Enterovirus, señale la opción INCORRECTA:",
    option1: "Diferentes enterovirus pueden causar un mismo síndrome o cuadro clínico.",
    option2: "La mayoría de los infectados por poliovirus desarrollan parálisis espinal.",
    option3: "Además de meningitis y encefalitis, pueden causar infecciones que afectan piel, huesos y articulaciones.",
    option4: "La infección inicial se acompaña de un extenso daño directo en las mucosas de los pies.",
    correct: "La infección inicial se acompaña de un extenso daño directo en las mucosas de los pies."
  },
  {
    id: 27,
    title: "Respecto al establecimiento de latencia viral, señale la opción CORRECTA:",
    option1: "VZV y EBV tienen en común la capacidad de establecer latencia integrándose al genoma del hospedador.",
    option2: "Proteínas tegumentarias de los HSV y CMV favorecen el establecimiento de la latencia.",
    option3: "Las neuronas y linfocitos T CD4+ quiescentes son células susceptibles no permisivas donde pueden hacer latencia HSV-1 y el HIV, respectivamente.",
    option4: "Para que ocurra la latencia, el genoma del HPV tiene que pasar por un intermediario de ARN.",
    correct: "Proteínas tegumentarias de los HSV y CMV favorecen el establecimiento de la latencia."
  },
  {
    id: 28,
    title: "Señale cuál de los siguientes virus no puede ser transmitido de forma zoonótica al humano:",
    option1: "Junín.",
    option2: "Andes.",
    option3: "Poxvirus.",
    option4: "Molusco contagioso.",
    correct: "Molusco contagioso."
  },
  {
    id: 29,
    title: "Con respecto a la patogénesis de las infecciones virales, señale la opción INCORRECTA:",
    option1: "El acceso al sistema nervioso central de un virus puede ocurrir sin viremia previa.",
    option2: "Por definición, los exantemas virales son lesiones cutáneas, aunque en algunas predominan virus sistémicos.",
    option3: "El daño producido por una infección viral en las vías respiratorias puede involucrar mecanismos de inmunopatología.",
    option4: "Algunos virus pueden alterar directamente la capacidad mitótica de una célula tras infectarla.",
    correct: "Por definición, los exantemas virales son lesiones cutáneas, aunque en algunas predominan virus sistémicos."
  },
  {
    id: 30,
    title: "En referencia a las generalidades sobre genética viral, señale la opción INCORRECTA:",
    option1: "Las mutaciones en los virus de ARN ocurren independientemente de qué polaridad presente el ARN.",
    option2: "Cuando ocurre un cambio nucleotídico puntual por mutación, el fitness viral puede permanecer igual.",
    option3: "Hay virus que se transmiten al hombre desde animales infectados cuya variabilidad involucra la recombinación genética.",
    option4: "Las mutaciones en genes estructurales no tienen consecuencias en el fitness viral.",
    correct: "Las mutaciones en genes estructurales no tienen consecuencias en el fitness viral."
  },
  {
    id: 31,
    title: "Entre las siguientes opciones referidas a la variabilidad viral, señale la opción INCORRECTA:",
    option1: "La recombinación genética puede promover una gran variabilidad antigénica durante la replicación del HIV.",
    option2: "En un hospedador dado, integrando las cuasiespecies del HBV que lo infecta, puedes encontrar variantes con diferentes perfiles antigénicos.",
    option3: "Los virus con genoma ARN que replican en el núcleo están muy restringidos en su variabilidad.",
    option4: "Un virus que presenta múltiples genotipos podría presentar un único serotipo.",
    correct: "Los virus con genoma ARN que replican en el núcleo están muy restringidos en su variabilidad."
  },
  {
    id: 32,
    title: "Entre las siguientes aseveraciones, señale la CORRECTA:",
    option1: "Las proteínas no estructurales pueden causar daño directo en una célula infectada.",
    option2: "Por definición, resultará inocuo el ingreso de un virus a una célula no permisiva.",
    option3: "Los virus con genoma ARN están imposibilitados de integrarse al genoma de la célula hospedadora.",
    option4: "Por definición, un virus que replica en una célula no permisiva libera virus defectivos.",
    correct: "Las proteínas no estructurales pueden causar daño directo en una célula infectada."
  },
  {
    id: 33,
    title: "Con referencia a diversos mecanismos de patogénesis viral, señale la opción CORRECTA:",
    option1: "Los anticuerpos neutralizantes desarrollados tras una infección por un serotipo dado del virus polio no confieren protección homotípica de larga duración.",
    option2: "En el daño epitelial promovido por el virus herpes simplex-1 se incluyen la lisis celular y la formación de síncidos.",
    option3: "Por las similitudes antigénicas, la respuesta humoral específica en mucosas anti-Coxsackie A confiere protección cruzada anti-Coxsackie B.",
    option4: "La fiebre, artralgias y exantema son manifestaciones patognomónicas de la infección por virus dengue.",
    correct: "En el daño epitelial promovido por el virus herpes simplex-1 se incluyen la lisis celular y la formación de síncidos."
  },
  {
    id: 34,
    title: "Con respecto a los mecanismos de daño de infecciones virales, señale la opción CORRECTA:",
    option1: "La miocarditis en la infección por virus Coxsackie B no involucra el daño indirecto.",
    option2: "Las lesiones asociadas a los poxvirus son consecuencia de su diseminación linfohemática que están ausentes en inmunocomprometidos.",
    option3: "Los fenómenos de hipersensibilidad que se pueden desencadenar durante una infección viral (virus Chikungunya, parvovirus B19, HBV) son ejemplo de daño indirecto.",
    option4: "La baja patogenicidad del virus sarampión se adjudica a su incapacidad para replicar en células epiteliales del tracto respiratorio.",
    correct: "Los fenómenos de hipersensibilidad que se pueden desencadenar durante una infección viral (virus Chikungunya, parvovirus B19, HBV) son ejemplo de daño indirecto."
  },
  {
    id: 35,
    title: "Las siguientes afirmaciones ilustran ejemplos de mecanismos de daño directo en infecciones virales, EXCEPTO:",
    option1: "Lisis de neuronas infectadas por virus de la rabia.",
    option2: "Alteración de la funcionalidad de células dendríticas por virus del sarampión.",
    option3: "Lisis de precursores eritroides por parvovirus B19.",
    option4: "Lisis de motoneuronas por VZV.",
    correct: "Alteración de la funcionalidad de células dendríticas por virus del sarampión."
  },
  {
    id: 36,
    title: "En relación a la patogénesis de los rotavirus humanos, señale la opción CORRECTA:",
    option1: "La magnitud de la viremia que acompaña a la diarrea disminuye conforme avanza el cuadro de gastroenteritis.",
    option2: "La capacidad de absorción disminuye tras el reemplazo de enterocitos maduros (infectados y lisados) por inmaduros.",
    option3: "Mediadores liberados por la respuesta inmune celular específica son responsables del aumento del peristaltismo intestinal.",
    option4: "La limitación de la infección ocurre independientemente de la respuesta inmune humoral y celular específica.",
    correct: "La capacidad de absorción disminuye tras el reemplazo de enterocitos maduros (infectados y lisados) por inmaduros."
  },
  {
    id: 37,
    title: "Entre las siguientes opciones, señale la CORRECTA:",
    option1: "La cepa H1N1 de virus influenza pandémico de 1918 circuló como tal hasta 2009.",
    option2: "Las mutaciones puntuales en los genes H y N del virus influenza pueden generar variantes estacionales.",
    option3: "Las infecciones por el virus sarampión, parvovirus B19 y Andes comparten la vía de entrada y las células diana.",
    option4: "El virus influenza A aviar no puede infectar al humano porque carece de hemaglutinina.",
    correct: "Las mutaciones puntuales en los genes H y N del virus influenza pueden generar variantes estacionales."
  },
  {
    id: 38,
    title: "Respecto de los rinovirus humanos (HRV), señale la aseveración CORRECTA:",
    option1: "Por la eficiente protección cruzada entre los serotipos, las reinfecciones son infrecuentes.",
    option2: "Semejante a los enterovirus, se asocian a la producción de diarrea osmótica.",
    option3: "Semejante al virus influenza, el daño que producen favorece las sobreinfecciones bacterianas.",
    option4: "Por su estacionalidad, la contribución para desencadenar exacerbaciones asmáticas es escasa.",
    correct: "Semejante al virus influenza, el daño que producen favorece las sobreinfecciones bacterianas."
  },
  {
    id: 39,
    title: "¿Cuál de los siguientes enunciados es INCORRECTO?",
    option1: "Los adenovirus que producen gastroenteritis tienen diferencias antigénicas con los que producen infecciones respiratorias.",
    option2: "El reservorio animal de virus Junín dificulta su erradicación, aun disponiendo de una vacuna.",
    option3: "El daño extrahepático por el HBV requiere de la integración del genoma viral al genoma celular.",
    option4: "Una vacuna para HPV basada en las proteínas L virales carece de riesgo oncogénico asociado.",
    correct: "El daño extrahepático por el HBV requiere de la integración del genoma viral al genoma celular."
  },
  {
    id: 40,
    title: "En relación a la respuesta inmune antiviral mediada por los interferones de tipo 1 (IFN-1), señale la opción INCORRECTA:",
    option1: "La producción de IFN-I involucra el reconocimiento de los PAMPs virales por los receptores de reconocimiento de patrones (RRPs).",
    option2: "Los IFN-I interactúan con receptores específicos presentes en las células infectadas y no infectadas.",
    option3: "Los IFN-I están impedidos de promover la degradación del ARN de los virus con genoma ARN de polaridad negativa.",
    option4: "Los IFN-I promueven el aumento de la expresión del CMH-I, favoreciendo la lisis de las células infectadas por células T CD8+ específicas.",
    correct: "Los IFN-I están impedidos de promover la degradación del ARN de los virus con genoma ARN de polaridad negativa."
  },
  {
    id: 41,
    title: "Entre los siguientes enunciados, señale el que considere CORRECTO:",
    option1: "La patogenicidad de un virus dado depende de su nivel de virulencia.",
    option2: "Para algunos virus, la célula en la que hace latencia puede ser permisiva para su replicación.",
    option3: "Los virus respiratorios con capacidad de generar infecciones diseminadas no causan infecciones congénitas.",
    option4: "Los sensores celulares para ADN foráneo no pueden participar en la respuesta inmune frente a virus de genoma ARN.",
    correct: "Para algunos virus, la célula en la que hace latencia puede ser permisiva para su replicación."
  },
  {
    id: 42,
    title: "Las siguientes infecciones virales son causa de linfopenia, EXCEPTO:",
    option1: "HIV.",
    option2: "EBV.",
    option3: "Virus Junín.",
    option4: "Virus sarampión.",
    correct: "Virus Junín."
  },
  {
    id: 43,
    title: "¿Cuál de los siguientes NO ES un blanco de acción de antivirales de uso actual?",
    option1: "Proteasa del HIV.",
    option2: "Polimerasa del HCV.",
    option3: "Neuraminidasa del virus influenza.",
    option4: "Polimerasa del HPV.",
    correct: "Polimerasa del HPV."
  },
  {
    id: 44,
    title: "Entre los siguientes enunciados, señale el INCORRECTO:",
    option1: "La infección del epitelio alveolar por el SARS-CoV-2 puede alterar la hematosis.",
    option2: "La integración del genoma del HIV somete su expresión y la replicación viral al control epigenético.",
    option3: "El genoma ARN del virus hepatitis C se circulariza tras su ingreso al núcleo, donde se asocia a histonas.",
    option4: "Durante la latencia en el núcleo de las neuronas, los virus VZV y HSV presentan su genoma ADN epigenéticamente modificado por histonas celulares.",
    correct: "El genoma ARN del virus hepatitis C se circulariza tras su ingreso al núcleo, donde se asocia a histonas."
  },
  {
    id: 45,
    title: "En relación a la latencia del HIV, indique la opción CORRECTA:",
    option1: "Se favorece la latencia cuando la célula infectada se encuentra activada.",
    option2: "En etapas tempranas de la infección, las proteínas virales del tegumento que inducen la latencia están presentes en baja cantidad.",
    option3: "Durante la latencia, el genoma proviral podrá encontrarse en estado de heterocromatina.",
    option4: "Si la carga viral plasmática es indetectable, resulta improbable que haya linfocitos T CD4+ con genoma proviral.",
    correct: "Durante la latencia, el genoma proviral podrá encontrarse en estado de heterocromatina."
  },
  {
    id: 46,
    title: "Tras la primoinfección por el HIV y la aparición del síndrome de inmunodeficiencia adquirida (SIDA), sin mediar intervención terapéutica, se observan los siguientes eventos patogénicos, EXCEPTO:",
    option1: "Localización viral excluyente en el GALT, produciendo un profundo daño tisular.",
    option2: "Disminución progresiva de linfocitos T CD4+ consecuencia de mecanismos de muerte celular.",
    option3: "Estado de inflamación generalizado y persistente que impacta en la funcionalidad de diversos tejidos.",
    option4: "Linfocitos T CD4+ infectados en 'reposo' aportando al reservorio viral.",
    correct: "Localización viral excluyente en el GALT, produciendo un profundo daño tisular."
  },
  {
    id: 47,
    title: "¿Cuál de los siguientes estímulos NO logra revertir el estado de latencia del HIV en linfocitos T CD4+CCR5+ infectados?",
    option1: "Terapia antiviral con inhibidores de la transcriptasa inversa.",
    option2: "Citoquinas pro-inflamatorias.",
    option3: "Sobre-infección con otros virus.",
    option4: "Aumento de la concentración plasmática de LPS (lipopolisacárido) bacteriano.",
    correct: "Terapia antiviral con inhibidores de la transcriptasa inversa."
  },
  {
    id: 48,
    title: "Entre las siguientes opciones relacionadas con la patogénesis del virus papiloma humano, señale la que considere INCORRECTA:",
    option1: "La progresión de lesiones precancerosas causadas por el HPV es multifactorial y puede favorecerse por hábitos tales como el tabaquismo.",
    option2: "La integración del genoma viral del HPV es un proceso indispensable para la oncogénesis.",
    option3: "La pérdida de integridad del gen regulador E2 de algunos genotipos del HPV promueve la sobre-expresión de los oncogenes virales E6 y E7.",
    option4: "La infección con un genotipo de alto riesgo del HPV (por ejemplo, 16 o 18) conduce inexorablemente hacia la transformación celular.",
    correct: "La infección con un genotipo de alto riesgo del HPV (por ejemplo, 16 o 18) conduce inexorablemente hacia la transformación celular."
  },
  {
    id: 49,
    title: "Entre las siguientes opciones sobre los virus de la familia Herpesviridae, señale la CORRECTA:",
    option1: "Los queratinocitos y células epiteliales son los principales tipos celulares para el establecimiento de la latencia del citomegalovirus humano.",
    option2: "El mantenimiento de la latencia de los virus herpes simplex está mediada por la expresión de genes tardíos (gamma).",
    option3: "La reactivación de una infección latente por el virus varicela-zóster suele ser sintomática en individuos inmunosuprimidos, produciendo lesiones vesiculares habitadas en piel.",
    option4: "La replicación del virus Epstein-Barr en linfocitos T residentes en el GALT facilita la infección de los enterocitos.",
    correct: "La reactivación de una infección latente por el virus varicela-zóster suele ser sintomática en individuos inmunosuprimidos, produciendo lesiones vesiculares habitadas en piel."
  },
  {
    id: 50,
    title: "En relación con la patogénesis del virus Epstein Barr (EBV), señale la opción CORRECTA:",
    option1: "Las proteínas de membrana LMPs codificadas por el EBV participan en la activación y proliferación de linfocitos B.",
    option2: "La proteína EBNA-I del EBV es responsable de la integración del genoma viral al celular lo que conlleva al establecimiento de la latencia 0.",
    option3: "El virus Epstein-Barr persiste en linfocitos B naive mediante la expresión de sus proteínas que favorecen la sobrevida y proliferación celular (latencia 0).",
    option4: "La presencia de anticuerpos heterófilos promueve la formación de inmunocomplejos con antígenos parasitarios que desencadena el linfoma de Burkitt.",
    correct: "Las proteínas de membrana LMPs codificadas por el EBV participan en la activación y proliferación de linfocitos B."
  },
  {
    id: 51,
    title: "Respecto de la patogénesis de los virus herpes simplex, señale la opción CORRECTA:",
    option1: "Las infecciones neonatales presentan consecuencias más graves en aquellos casos en los que la madre cursa una primoinfección.",
    option2: "La reactivación de la replicación a partir de un estado de latencia implica la lisis de la neurona infectada.",
    option3: "En las encefalitis herpéticas el daño neuronal se relaciona con una mayor expresión de LATs en aquellas cepas más virulentas.",
    option4: "Las proteínas del tegumento de los herpesvirus son esenciales para mantener al genoma viral no integrado al núcleo celular (episoma).",
    correct: "Las infecciones neonatales presentan consecuencias más graves en aquellos casos en los que la madre cursa una primoinfección."
  },
  {
    id: 52,
    title: "¿Cuál de las siguientes condiciones NO favorece la persistencia de un virus en el huésped?",
    option1: "Infección productiva no asociada a efecto citopático directo.",
    option2: "Integración del genoma viral en la célula hospedadora.",
    option3: "Evadir la acción de proteínas efectoras inducidas por los interferones de tipo I.",
    option4: "Estabilidad genética y antigénica.",
    correct: "Estabilidad genética y antigénica."
  },
  {
    id: 53,
    title: "¿Cuál de los siguientes mecanismos virales estimula la muerte programada de la célula infectada?",
    option1: "EBV tras producir una proteína Bcl-2 simil.",
    option2: "Gp120 del HIV-1 al interactuar con sus receptores celulares.",
    option3: "E7 del HPV al promover la degradación de la pRb.",
    option4: "CMV al producir una proteína β2-microglobulina simil.",
    correct: "Gp120 del HIV-1 al interactuar con sus receptores celulares."
  }
];

export const microFungiQuestions = [
  {
    id: 1,
    title: "Con respecto a los hongos dimórficos, señale la opción INCORRECTA:",
    option1: "Pueden existir en forma de levadura o de moho.",
    option2: "La forma de levadura suele ser patógena en humanos.",
    option3: "La forma de moho crece a temperaturas corporales humanas.",
    option4: "Histoplasma capsulatum es un ejemplo de hongo dimórfico.",
    correct: "La forma de moho crece a temperaturas corporales humanas.",
  },
  {
    id: 2,
    title:
      "¿Cuál de los siguientes NO es un factor de virulencia común en los hongos patógenos?",
    option1: "Producción de enzimas que degradan tejidos del huésped.",
    option2: "Capacidad para crecer a 37°C.",
    option3: "Capacidad para formar esporas altamente resistentes.",
    option4: "Producción de toxinas que afectan al huésped.",
    correct: "Capacidad para formar esporas altamente resistentes.",
  },
  {
    id: 3,
    title:
      "Con respecto a la pared celular de los hongos, señale la opción CORRECTA:",
    option1: "Está compuesta principalmente por celulosa.",
    option2: "Contiene quitina y glucanos.",
    option3: "Es similar a la pared celular de las plantas.",
    option4: "Carece de ergosterol.",
    correct: "Contiene quitina y glucanos.",
  },
  {
    id: 4,
    title:
      "¿Cuál de las siguientes características NO es típica de los hongos oportunistas?",
    option1: "Infectan principalmente a individuos inmunocomprometidos.",
    option2: "Pueden causar infecciones sistémicas graves.",
    option3: "Siempre son patógenos primarios.",
    option4: "Ejemplos incluyen Candida y Aspergillus.",
    correct: "Siempre son patógenos primarios.",
  },
  {
    id: 5,
    title:
      "Con respecto a la reproducción en hongos, señale la opción INCORRECTA:",
    option1: "Pueden reproducirse asexualmente mediante esporas.",
    option2: "La reproducción sexual involucra la fusión de hifas compatibles.",
    option3: "La gemación es un tipo de reproducción asexual en levaduras.",
    option4: "Los hongos no tienen ciclos de reproducción sexual.",
    correct: "Los hongos no tienen ciclos de reproducción sexual.",
  },
  {
    id: 6,
    title: "¿Cuál de los siguientes hongos es un patógeno humano importante?",
    option1: "Saccharomyces cerevisiae",
    option2: "Candida albicans",
    option3: "Penicillium notatum",
    option4: "Rhizopus stolonifer",
    correct: "Candida albicans.",
  },
  {
    id: 7,
    title:
      "¿Cuál de las siguientes características es típica de las infecciones por dermatofitos?",
    option1: "Afectan principalmente los órganos internos.",
    option2: "Causan infecciones en la piel, cabello y uñas.",
    option3: "Se transmiten exclusivamente por contacto directo con animales.",
    option4: "Siempre resultan en infecciones sistémicas.",
    correct: "Causan infecciones en la piel, cabello y uñas.",
  },
  {
    id: 8,
    title: "Con respecto a las micosis profundas, señale la opción INCORRECTA:",
    option1: "Pueden afectar órganos internos como los pulmones.",
    option2:
      "Son causadas por hongos que ingresan al cuerpo por inhalación o heridas.",
    option3: "El tratamiento suele requerir antifúngicos sistémicos.",
    option4: "Son siempre causadas por hongos dimórficos.",
    correct: "Son siempre causadas por hongos dimórficos.",
  },
  {
    id: 9,
    title:
      "¿Cuál de los siguientes mecanismos NO es una estrategia de evasión inmune por parte de los hongos?",
    option1: "Producción de cápsulas que inhiben la fagocitosis.",
    option2: "Cambio de forma morfológica.",
    option3: "Secreción de enzimas que destruyen anticuerpos.",
    option4: "Formación de biofilms resistentes.",
    correct: "Secreción de enzimas que destruyen anticuerpos.",
  },
  {
    id: 10,
    title: "Con respecto a los antifúngicos, señale la opción CORRECTA:",
    option1: "La anfotericina B actúa sobre la síntesis de la pared celular.",
    option2: "Los azoles inhiben la síntesis de ergosterol.",
    option3: "Las equinocandinas interfieren con la replicación del ADN.",
    option4: "La nistatina se usa comúnmente para infecciones sistémicas.",
    correct: "Los azoles inhiben la síntesis de ergosterol.",
  },
  {
    id: 11,
    title: "¿Qué característica define a un hongo filamentoso?",
    option1: "Crecen en forma de levadura a 37°C.",
    option2: "Forman estructuras llamadas hifas.",
    option3: "No producen esporas.",
    option4: "Siempre causan enfermedades en humanos.",
    correct: "Forman estructuras llamadas hifas.",
  },
  {
    id: 12,
    title: "Con respecto a la criptococosis, señale la opción CORRECTA:",
    option1: "Es causada por Candida albicans.",
    option2: "Afecta principalmente a individuos inmunocompetentes.",
    option3: "La cápsula polisacárida es un factor de virulencia importante.",
    option4: "Siempre se limita a infecciones cutáneas.",
    correct: "La cápsula polisacárida es un factor de virulencia importante.",
  },
  {
    id: 13,
    title:
      "¿Cuál de las siguientes afirmaciones sobre Aspergillus es INCORRECTA?",
    option1: "Puede causar aspergilosis pulmonar invasiva.",
    option2: "Produce esporas que se dispersan en el aire.",
    option3: "Siempre se manifiesta como una infección oportunista.",
    option4: "Algunas especies de Aspergillus producen aflatoxinas.",
    correct: "Siempre se manifiesta como una infección oportunista.",
  },
  {
    id: 14,
    title:
      "¿Cuál de las siguientes micosis es típicamente causada por un hongo dimórfico?",
    option1: "Candidiasis",
    option2: "Dermatofitosis",
    option3: "Histoplasmosis",
    option4: "Aspergilosis",
    correct: "Histoplasmosis.",
  },
  {
    id: 15,
    title:
      "Con respecto a los hongos y su relación con el huésped, señale la opción INCORRECTA:",
    option1: "Pueden formar simbiosis beneficiosas con plantas.",
    option2: "Algunos hongos son parte de la microbiota normal humana.",
    option3: "Siempre causan enfermedades en humanos.",
    option4: "Pueden producir micotoxinas dañinas.",
    correct: "Siempre causan enfermedades en humanos.",
  },
  {
    id: 16,
    title:
      "¿Cuál de las siguientes características es típica de los hongos basidiomicetos?",
    option1: "Producen esporas en estructuras llamadas basidios.",
    option2: "Causan principalmente infecciones sistémicas en humanos.",
    option3: "Son unicelulares y se reproducen por gemación.",
    option4: "Carecen de pared celular.",
    correct: "Producen esporas en estructuras llamadas basidios.",
  },
  {
    id: 17,
    title:
      "Con respecto a las infecciones por Candida, señale la opción INCORRECTA:",
    option1: "Pueden ser superficiales o sistémicas.",
    option2: "C. albicans es la especie más común en infecciones humanas.",
    option3: "La candidiasis oral es una manifestación común.",
    option4: "Nunca causan infecciones nosocomiales.",
    correct: "Nunca causan infecciones nosocomiales.",
  },
  {
    id: 18,
    title:
      "¿Cuál de las siguientes afirmaciones sobre los hongos Zigomicetos es CORRECTA?",
    option1: "Carecen de pared celular.",
    option2: "Son conocidos por causar mucormicosis.",
    option3: "Se reproducen exclusivamente de forma asexual.",
    option4: "Siempre son patógenos en humanos.",
    correct: "Son conocidos por causar mucormicosis.",
  },
  {
    id: 19,
    title:
      "Con respecto a las infecciones fúngicas profundas, señale la opción CORRECTA:",
    option1: "Son causadas exclusivamente por hongos levaduriformes.",
    option2: "El tratamiento generalmente no requiere antifúngicos sistémicos.",
    option3: "Histoplasma capsulatum puede causar infecciones profundas.",
    option4: "Siempre se transmiten por contacto directo.",
    correct: "Histoplasma capsulatum puede causar infecciones profundas.",
  },
  {
    id: 20,
    title:
      "¿Cuál de los siguientes NO es un mecanismo de resistencia antifúngica?",
    option1: "Alteración del sitio de acción del fármaco.",
    option2: "Aumento de la síntesis de ergosterol.",
    option3: "Bombeo activo del fármaco fuera de la célula.",
    option4: "Desactivación enzimática del fármaco.",
    correct: "Aumento de la síntesis de ergosterol.",
  },
  // Preguntas de choice
  {
    id: 21,
    title: "Con respecto a las siguientes asociaciones entre las formas parasitarias observadas y su correspondiente micosis. Señale la opción INCORRECTA:",
    option1: "Levaduras con pseudohifas/ Onicomicosis por Candida.",
    option2: "Artroconidias en posición ectothrix al pelo/ Tinea capitis.",
    option3: "Levaduras junto con filamentos cortos y anchos/ Pitiriasis versicolor.",
    option4: "Hifas pigmentadas/ Tinea pedis.",
    correct: "Hifas pigmentadas/ Tinea pedis."
  },
  {
    id: 22,
    title: "Señale la asociación INCORRECTA:",
    option1: "Piedraia hortae / piedra blanca.",
    option2: "Especies de Fusarium / queratitis.",
    option3: "Trichophyton rubrum, especies de Candida y de Fusarium / Onicomicosis.",
    option4: "Especies de Trichosporon / fungemia en pacientes neutropénicos u oncohematológicos.",
    correct: "Piedraia hortae / piedra blanca."
  },
  {
    id: 23,
    title: "Con respecto al mecanismo de acción de los antifúngicos, Señale la opción CORRECTA:",
    option1: "La griseofulvina produce la inhibición del crecimiento fúngico por interferencia en la mitosis.",
    option2: "La asociación de trimetoprima-sulfametoxazol permite la inhibición de la síntesis de las bases pirimidicas.",
    option3: "La anidulafungina al unirse a su sitio de acción provoca la lisis por apoptosis de las especies fúngicas con talo filamentoso.",
    option4: "Los derivados poliénicos provocan una inhibición selectiva de la quitinsintetasa.",
    correct: "La griseofulvina produce la inhibición del crecimiento fúngico por interferencia en la mitosis."
  },
  {
    id: 24,
    title: "Con respecto a las siguientes asociaciones entre la pared celular y su composición, Señale la opción CORRECTA:",
    option1: "Matriz fibrilar / moléculas de galactosamina.",
    option2: "Matriz amorfa / polímeros de glucanos.",
    option3: "Proteínas de pared / Enzimas de la cadena respiratoria.",
    option4: "Fosfolípidos de la matriz amorfa / ergosterol.",
    correct: "Matriz amorfa / polímeros de glucanos."
  },
  {
    id: 25,
    title: "En relación con las siguientes especies fúngicas. Señale la opción INCORRECTA:",
    option1: "Las especies de Fusarium, Aspergillus y Rhizopus comparten las características de sus hifas.",
    option2: "Especies de Fusarium, Aspergillus y mucorales producen escaras necróticas en la piel como manifestaciones de las formas diseminadas de las respectivas micosis.",
    option3: "La neutropenia severa y prolongada se asocia a la aspergilosis invasora y a la mucormicosis diseminada.",
    option4: "La angioinvasión y diseminación de embolo fúngicos a distancia es característica de la forma de la aspergilosis invasora.",
    correct: "Las especies de Fusarium, Aspergillus y Rhizopus comparten las características de sus hifas."
  },
  {
    id: 26,
    title: "Las siguientes son asociaciones entre los mecanismos de evasión y las especies fúngicas. Señale la opción INCORRECTA:",
    option1: "Formación de levaduras gigantes / Candida albicans.",
    option2: "Liberación de polisacárido capsular / Cryptococcus neoformans.",
    option3: "Producción de arginasa 1 / Coccidioides spp.",
    option4: "Adquisición de proteínas regulatorias de la cascada de complemento (FII y FHLI) / Candida sp.",
    correct: "Formación de levaduras gigantes / Candida albicans."
  },
  {
    id: 27,
    title: "Las enfermedades fúngicas invasoras por especies de Candida, Aspergillus o Fusarium tienen los siguientes factores de riesgo, EXCEPTO:",
    option1: "Neutropenia sostenida (menos de 500 neutrófilos/ml al menos durante 10 días).",
    option2: "Transplante alogénico de células progenitoras hematopoyéticas (HSCT).",
    option3: "Uso de deferoxamina.",
    option4: "Enfermedades oncohematológicas.",
    correct: "Enfermedades oncohematológicas."
  },
  {
    id: 28,
    title: "Con respecto a las especies del complejo Sporothrix schenckii, señale la opción CORRECTA:",
    option1: "Requieren del parasitismo en el hombre para completar su ciclo de vida.",
    option2: "Las manifestaciones clínicas del síndrome linfangítico nodular corresponden a una reinfección.",
    option3: "La diferenciación de las especies del complejo se realiza por criterios morfológicos.",
    option4: "Puede tener una transmisión zoonótica.",
    correct: "Puede tener una transmisión zoonótica."
  },
  {
    id: 29,
    title: "Las siguientes especies fúngicas se pueden adquirir por contacto interhumano, Señale la opción INCORRECTA.",
    option1: "Complejo Candida parapsilosis.",
    option2: "Coccidioides pasadasit.",
    option3: "Pneumocystis jirovecii.",
    option4: "Epidermophyton floccosum.",
    correct: "Coccidioides pasadasit."
  },
  {
    id: 30,
    title: "En relación con la detección de galactomanano como biomarcador en infecciones por especies fúngicas de talo filamentoso, Señale la opción CORRECTA:",
    option1: "Es producido exclusivamente por especies de Aspergillus sección fumigati.",
    option2: "Es insoluble en líquidos biológicos (suero, lavado broncoalveolar) y por lo tanto no se lo considera como un exoantígeno fúngico.",
    option3: "La presencia en suero se considera un marcador de angioinvasión en pacientes neutropénicos graves.",
    option4: "Es especialmente útil como marcador de infección en pacientes con agamaglobulinemia.",
    correct: "La presencia en suero se considera un marcador de angioinvasión en pacientes neutropénicos graves."
  },
  {
    id: 31,
    title: "Con respecto a las características de las especies fúngicas productoras de mucormicosis, Señale la opción INCORRECTA:",
    option1: "En pacientes neutropénicos producen angioinvasión.",
    option2: "Desarrollan procesos de invasión y diseminación de curso rápido (procesos agudos).",
    option3: "Producen émbolos fúngicos que participan en la invasión.",
    option4: "Los esporos y esporangiosporos encontrados en los tejidos son los responsables de la diseminación hemática.",
    correct: "Los esporos y esporangiosporos encontrados en los tejidos son los responsables de la diseminación hemática."
  },
  {
    id: 32,
    title: "Con respecto a las especies del complejo Purucoccidioides brasiliensis y a la paracoccidioidomicosis, Señale la opción INCORRECTA:",
    option1: "La forma parasitaria corresponde a un talo levaduriforme.",
    option2: "Es un hongo cuya área endémica se encuentra delimitada en América Latina.",
    option3: "La paracoccidioidomicosis puede producirse por reactivación de un foco primario de infección.",
    option4: "En el 70% de los casos la primoinfección es sintomática.",
    correct: "En el 70% de los casos la primoinfección es sintomática."
  },
  {
    id: 33,
    title: "Las siguientes son características del Querion de Celso, EXCEPTO:",
    option1: "Se asocia a infecciones producidas por dermatofitos zoófilos o geófilos.",
    option2: "Se caracteriza por un aumento de la respuesta inflamatoria local.",
    option3: "Puede asociarse a adenopatías cervicales debido a la presentación antigénica realizada por la célula presentadora de antígeno.",
    option4: "La secreción purulenta se debe indefectiblemente a las sobreinfecciones bacterianas.",
    correct: "La secreción purulenta se debe indefectiblemente a las sobreinfecciones bacterianas."
  },
  {
    id: 34,
    title: "Con respecto a los factores de virulencia de las especies de Aspergillus sección fumigati, señale la opción INCORRECTA:",
    option1: "Utilizan el galactomanano para la adherencia a las células del hospedero.",
    option2: "Sus conidios presentan la más baja velocidad de germinación al compararlo con las especies de complejo (sección) Flavi y Nigri.",
    option3: "Produce gliotoxina cuya función es inhibir la fagocitosis, la formación NADPH oxidase y facilitar la apoptosis de las células del sistema inmune del hospedero.",
    option4: "El ácido siálico participa en la adhesión a la matriz extracelular de las células del hospedero.",
    correct: "Utilizan el galactomanano para la adherencia a las células del hospedero."
  },
  {
    id: 35,
    title: "Con respecto a las siguientes especies fúngicas productoras de micosis superficiales. Señale la opción INCORRECTA:",
    option1: "La especie Trichophyton rubrum puede causar infecciones en el ámbito familiar.",
    option2: "Las especies de Malassezia spp producen alteración de la pigmentación de la piel.",
    option3: "Especies de Trichosporon pueden parasitar el cabello en la porción extrafolicular en la entidad conocida como piedra blanca.",
    option4: "La especie Trichophyton tonsurans es el principal agente productor de perionixis y onixis con compromiso distal subungual.",
    correct: "La especie Trichophyton tonsurans es el principal agente productor de perionixis y onixis con compromiso distal subungual."
  },
  {
    id: 36,
    title: "Con respecto a las características epidemiológicas de la candidiasis invasora por Candida parapsilosis, Señale la opción INCORRECTA:",
    option1: "El uso de fluconazol previo constituye un factor de riesgo.",
    option2: "Las infecciones relacionadas a sondas o catéteres pueden tener una vía de infección exógena.",
    option3: "Es la segunda especie más frecuentemente aislada en nuestro país.",
    option4: "Se encuentra colonizando la piel del personal de salud.",
    correct: "Es la segunda especie más frecuentemente aislada en nuestro país."
  },
  {
    id: 37,
    title: "Con respecto a las características de Pneumocystis jiroveci o de la neumocistosis, Señale la opción CORRECTA:",
    option1: "El principal factor de riesgo para desarrollar neumocistosis es un recuento de neutrófilos menor de 500/mm³.",
    option2: "La glicoproteína A o MSG es liberada al medio como señuelo e impide la unión al receptor de manosa de los macrófagos alveolares.",
    option3: "El hongo libera proteasas que lesionan el tejido pulmonar.",
    option4: "A nivel alveolar ocasiona un aumento de las proteínas hidrofóbicas SP-B y SP-C del factor surfactante.",
    correct: "La glicoproteína A o MSG es liberada al medio como señuelo e impide la unión al receptor de manosa de los macrófagos alveolares."
  },
  {
    id: 38,
    title: "Las siguientes son características utilizadas en la identificación de los hongos miceliales, EXCEPTO:",
    option1: "El tipo de nutrición.",
    option2: "El origen de los conidios por procesos blásticos o tálicos.",
    option3: "Las formaciones de estructuras especiales del talo vegetativo (rizoides).",
    option4: "Presencia de tabiques.",
    correct: "El tipo de nutrición."
  },
  {
    id: 39,
    title: "Con respecto a las especies de Cryptococcus, señale la opción CORRECTA:",
    option1: "La infección por las especies C. neoformans/C. grubii se adquiere exclusivamente en climas tropicales.",
    option2: "Cryptococcus spp es un hongo considerado dimorfo.",
    option3: "La cápsula de Cryptococcus neoformans favorece la migración de polimorfonucleares al sitio de infección.",
    option4: "La cápsula en Cryptococcus neoformans/grubii sufre modificaciones en su tamaño para el establecimiento a nivel pulmonar y durante la diseminación al SNC (sistema nervioso central).",
    correct: "La cápsula en Cryptococcus neoformans/grubii sufre modificaciones en su tamaño para el establecimiento a nivel pulmonar y durante la diseminación al SNC (sistema nervioso central)."
  },
  {
    id: 40,
    title: "¿Cuál de las siguientes es una asociación CORRECTA entre factores de riesgo, especie fúngica?",
    option1: "Microtraumatismos / Mucor circinelloides.",
    option2: "Infección por HIV/sida / Cryptococcus neoformans.",
    option3: "Hemodiálisis / Aspergillus niger.",
    option4: "Bronquiectasias / Pneumocystis jirovecii.",
    correct: "Infección por HIV/sida / Cryptococcus neoformans."
  },
  {
    id: 41,
    title: "Con respecto a la patogenia de las dermatoficias, Señale la opción INCORRECTA:",
    option1: "La producción de anticuerpos (IgG, IgA) en la dermis impide la invasión del hongo a los tejidos profundos.",
    option2: "Las especies fúngicas producen queratinasas y proteasas.",
    option3: "Los dermatofitos afectan la piel y sus faneras.",
    option4: "Los queratinocitos producen ILS y productos derivados del ácido araquidónico.",
    correct: "La producción de anticuerpos (IgG, IgA) en la dermis impide la invasión del hongo a los tejidos profundos."
  },
  {
    id: 42,
    title: "Con respecto a las siguientes asociaciones entre la especie fúngica y la morfología del talo fúngico de su forma parasitaria, Señale la asociación INCORRECTA:",
    option1: "Trematosphaeria grisea / granos negros.",
    option2: "Fusarium solani / granos blancos.",
    option3: "Phialophora verrucosa / Levaduras monogemantes.",
    option4: "Fonsecae pedrosoi / Cuerpos esclerotales.",
    correct: "Phialophora verrucosa / Levaduras monogemantes."
  },
  {
    id: 43,
    title: "Con respecto a los factores de virulencia de Histoplasma capsulatum, Señale la opción INCORRECTA:",
    option1: "Ingresa al macrófago por la unión de la proteína de shock térmico (hsp 60) a los receptores CD11b/CD18.",
    option2: "Histoplasma capsulatum incrementa el pH para evitar el ataque por medio de enzimas lisosomales.",
    option3: "Produce la liberación de la glicoproteína mayor de superficie (gpA) para evadir la respuesta inmunológica.",
    option4: "La exposición de α (1-3) D-glucanos es un componente importante en la pared de la forma parasitaria.",
    correct: "Histoplasma capsulatum incrementa el pH para evitar el ataque por medio de enzimas lisosomales."
  },
  {
    id: 44,
    title: "Con respecto a las características de los micetomas, Señale la opción INCORRECTA:",
    option1: "Los polimorfonucleares pueden rodear y degranular sobre la superficie de los granos especialmente durante la formación de los abscesos.",
    option2: "Presencia de nódulos de consistencia duro-leñosa con trayectos fistulosos.",
    option3: "Las hifas de las especies fúngicas se disponen formando una estructura visible.",
    option4: "Las especies fúngicas productoras de micetoma son consideradas dimórficas.",
    correct: "Las especies fúngicas productoras de micetoma son consideradas dimórficas."
  },
  {
    id: 45,
    title: "Los siguientes agentes fúngicos presentan una distribución mundial, EXCEPTO:",
    option1: "Sporothrix sp.",
    option2: "Aspergillus sp.",
    option3: "Candida auris.",
    option4: "Coccidioides posadasii.",
    correct: "Coccidioides posadasii."
  }
];

export const microBacteriumQuestions = [
  {
    id: 1,
    title:
      "Con respecto a la estructura de la pared celular bacteriana, señale la opción CORRECTA:",
    option1:
      "Las bacterias Gram-positivas tienen una capa gruesa de peptidoglicano.",
    option2: "Las bacterias Gram-negativas carecen de membrana externa.",
    option3:
      "El ácido teicoico es característico de las bacterias Gram-negativas.",
    option4: "El peptidoglicano está ausente en las bacterias Gram-positivas.",
    correct:
      "Las bacterias Gram-positivas tienen una capa gruesa de peptidoglicano.",
  },
  {
    id: 2,
    title:
      "¿Cuál de las siguientes afirmaciones sobre las esporas bacterianas es INCORRECTA?",
    option1: "Las esporas son estructuras de resistencia.",
    option2: "Las esporas son una forma de reproducción bacteriana.",
    option3: "Las esporas pueden resistir condiciones extremas.",
    option4: "Las esporas se forman en respuesta a condiciones adversas.",
    correct: "Las esporas son una forma de reproducción bacteriana.",
  },
  {
    id: 3,
    title:
      "Con respecto a la genética bacteriana, señale la opción INCORRECTA:",
    option1:
      "La conjugación involucra el intercambio de material genético a través de un pilus.",
    option2:
      "La transformación implica la absorción de ADN libre del ambiente.",
    option3: "La transducción es mediada por bacteriófagos.",
    option4: "Las mutaciones siempre son perjudiciales para las bacterias.",
    correct: "Las mutaciones siempre son perjudiciales para las bacterias.",
  },
  {
    id: 4,
    title:
      "¿Cuál de los siguientes mecanismos de resistencia a antibióticos es común en las bacterias?",
    option1: "Modificación del ADN ribosómico.",
    option2: "Inactivación enzimática del antibiótico.",
    option3: "Disminución de la permeabilidad de la membrana plasmática.",
    option4: "Incremento en la síntesis de pared celular.",
    correct: "Inactivación enzimática del antibiótico.",
  },
  {
    id: 5,
    title:
      "Con respecto a los mecanismos de patogenicidad bacteriana, señale la opción CORRECTA:",
    option1: "Las endotoxinas son producidas por bacterias Gram-positivas.",
    option2: "Las exotoxinas son secretadas activamente por las bacterias.",
    option3: "Las bacterias Gram-negativas no producen toxinas.",
    option4: "Las toxinas bacterianas nunca afectan a las células del huésped.",
    correct: "Las exotoxinas son secretadas activamente por las bacterias.",
  },
  {
    id: 6,
    title:
      "¿Cuál de las siguientes bacterias es un patógeno intracelular obligado?",
    option1: "Escherichia coli",
    option2: "Staphylococcus aureus",
    option3: "Mycobacterium tuberculosis",
    option4: "Chlamydia trachomatis",
    correct: "Chlamydia trachomatis.",
  },
  {
    id: 7,
    title: "¿Qué característica NO es típica de las bacterias Gram-negativas?",
    option1: "Poseen una membrana externa rica en lipopolisacáridos.",
    option2: "Tienen una capa gruesa de peptidoglicano.",
    option3: "Producen endotoxinas.",
    option4: "Tienen una capa delgada de peptidoglicano.",
    correct: "Tienen una capa gruesa de peptidoglicano.",
  },
  {
    id: 8,
    title: "Con respecto a la tinción de Gram, señale la opción INCORRECTA:",
    option1: "Las bacterias Gram-positivas retienen el cristal violeta.",
    option2: "Las bacterias Gram-negativas se decoloran con alcohol-acetona.",
    option3: "La safranina tiñe las bacterias Gram-negativas de rosa.",
    option4: "La tinción de Gram no diferencia entre tipos de bacterias.",
    correct: "La tinción de Gram no diferencia entre tipos de bacterias.",
  },
  {
    id: 9,
    title:
      "¿Cuál de las siguientes afirmaciones sobre la cápsula bacteriana es CORRECTA?",
    option1: "La cápsula siempre está presente en todas las bacterias.",
    option2: "La cápsula protege a la bacteria de la fagocitosis.",
    option3: "La cápsula es responsable de la movilidad bacteriana.",
    option4: "La cápsula se tiñe con la tinción de Gram.",
    correct: "La cápsula protege a la bacteria de la fagocitosis.",
  },
  {
    id: 10,
    title:
      "Con respecto a la estructura del flagelo bacteriano, señale la opción INCORRECTA:",
    option1: "El flagelo es responsable de la motilidad bacteriana.",
    option2: "El flagelo está compuesto por flagelina.",
    option3: "El flagelo se encuentra en todas las bacterias.",
    option4: "El flagelo se ancla en la membrana plasmática.",
    correct: "El flagelo se encuentra en todas las bacterias.",
  },
  {
    id: 11,
    title:
      "¿Cuál de los siguientes métodos NO es utilizado para la identificación de bacterias?",
    option1: "Tinción de Gram.",
    option2: "Cultivo en medios selectivos.",
    option3: "Pruebas bioquímicas.",
    option4: "Resonancia magnética nuclear.",
    correct: "Resonancia magnética nuclear.",
  },
  {
    id: 12,
    title:
      "Con respecto a los mecanismos de transferencia genética en bacterias, señale la opción CORRECTA:",
    option1: "La conjugación involucra bacteriófagos.",
    option2: "La transformación requiere contacto célula a célula.",
    option3: "La transducción puede ser generalizada o especializada.",
    option4:
      "La mutación es la única forma de variación genética en bacterias.",
    correct: "La transducción puede ser generalizada o especializada.",
  },
  {
    id: 13,
    title: "¿Qué afirmación sobre las micobacterias es INCORRECTA?",
    option1: "Tienen una pared celular rica en ácidos micólicos.",
    option2: "Son Gram-negativas.",
    option3: "Incluyen a Mycobacterium tuberculosis.",
    option4: "Son resistentes a la decoloración con alcohol-ácido.",
    correct: "Son Gram-negativas.",
  },
  {
    id: 14,
    title:
      "Con respecto a la resistencia bacteriana a los antibióticos, señale la opción CORRECTA:",
    option1: "La resistencia no puede ser transferida entre bacterias.",
    option2: "La resistencia puede ser mediada por plasmidios.",
    option3: "La resistencia siempre es causada por mutaciones cromosómicas.",
    option4: "La resistencia a los antibióticos es un fenómeno raro.",
    correct: "La resistencia puede ser mediada por plasmidios.",
  },
  {
    id: 15,
    title:
      "¿Cuál de las siguientes bacterias es conocida por producir esporas?",
    option1: "Escherichia coli",
    option2: "Clostridium botulinum",
    option3: "Staphylococcus aureus",
    option4: "Streptococcus pneumoniae",
    correct: "Clostridium botulinum.",
  },
  {
    id: 16,
    title:
      "Con respecto a la estructura de los ribosomas bacterianos, señale la opción INCORRECTA:",
    option1: "Son de tipo 70S.",
    option2: "Están compuestos por subunidades 50S y 30S.",
    option3: "Son el sitio de la síntesis proteica.",
    option4: "Son idénticos a los ribosomas eucariotas.",
    correct: "Son idénticos a los ribosomas eucariotas.",
  },
  {
    id: 17,
    title:
      "¿Cuál de las siguientes características NO es común en las bacterias ácido-alcohol resistentes?",
    option1: "Tienen una pared celular rica en ácidos micólicos.",
    option2: "Son resistentes a la decoloración con alcohol-ácido.",
    option3: "Incluyen especies como Mycobacterium.",
    option4: "Son Gram-negativas.",
    correct: "Son Gram-negativas.",
  },
  {
    id: 18,
    title:
      "Con respecto a los mecanismos de acción de los antibióticos, señale la opción CORRECTA:",
    option1: "Los betalactámicos inhiben la síntesis de proteínas.",
    option2: "Las quinolonas interfieren con la síntesis de ADN.",
    option3: "Los macrólidos alteran la membrana plasmática.",
    option4: "Los aminoglucósidos inhiben la síntesis de ácido fólico.",
    correct: "Las quinolonas interfieren con la síntesis de ADN.",
  },
  {
    id: 19,
    title:
    ...
    option1:
      "La microbiota normal está compuesta solo por bacterias patógenas.",
    option2: "La microbiota normal no tiene funciones beneficiosas.",
    option3:
      "La microbiota normal puede prevenir la colonización por patógenos.",
    option4: "La microbiota normal está presente solo en el intestino.",
    correct:
      "La microbiota normal puede prevenir la colonización por patógenos.",
  },
  {
    id: 20,
    title:
      "Con respecto a las bacterias anaerobias, señale la opción INCORRECTA:",
    option1: "Requieren oxígeno para su crecimiento.",
    option2: "Pueden ser obligadas o facultativas.",
    option3: "Pueden producir toxinas potentes.",
    option4: "Incluyen especies como Clostridium.",
    correct: "Requieren oxígeno para su crecimiento.",
  },
];

export const farmacoQuestions = [
  {
    id: 1,
    title:
